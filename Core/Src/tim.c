...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM1_MspPostInit 0 */
    ...
    PE13     ------> TIM1_CH3
    */
    GPIO_InitStruct.Pin = U_shape5_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM1;
    HAL_GPIO_Init(U_shape5_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = U_shape3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM1;
    HAL_GPIO_Init(U_shape3_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM2_MspPostInit 0 */
    ...
    PA1     ------> TIM2_CH2
    */
    GPIO_InitStruct.Pin = Arrow4_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(Arrow4_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM4_MspPostInit 0 */
    ...
    PD14     ------> TIM4_CH3
    */
    GPIO_InitStruct.Pin = U_shape4_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM4;
    HAL_GPIO_Init(U_shape4_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM5_MspPostInit 0 */
    ...
    PH10     ------> TIM5_CH1
    */
    GPIO_InitStruct.Pin = Arrow1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM5;
    HAL_GPIO_Init(Arrow1_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = U_shape1_Pin|Arrow5_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM5;
  ...
  /* USER CODE END TIM8_MspPostInit 0 */
    ...
    PI2     ------> TIM8_CH4
    */
    GPIO_InitStruct.Pin = U_shape2_Pin|Arrow3_Pin|Arrow2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
